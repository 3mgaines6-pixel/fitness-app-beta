/* =========================================
   ==========  MACHINE 9 — PEC FLY / REAR DELT
   ========================================= */

export function Machine9() {
  ...
  title.textContent = "#9 PEC FLY / REAR DELT";

  const subtitle = document.createElement("div");
  subtitle.className = "machine-subtitle";
  subtitle.textContent = "Chest / Shoulders • MODERATE • 3×10–12";
  ...
  tempoLabel.id = "tempo-label-9";
  tempoLabel.textContent = "Tempo ▸";

  const tempoValue = document.createElement("span");
  tempoValue.id = "tempo-value-9";
  ...
  timerDisplay.id = "timer-display-9";
