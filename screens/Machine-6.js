/* =========================================
   ==========  MACHINE 6 — SHOULDER PRESS
   ========================================= */

export function Machine6() {
  ...
  title.textContent = "#6 SHOULDER PRESS";

  const subtitle = document.createElement("div");
  subtitle.className = "machine-subtitle";
  subtitle.textContent = "Shoulders • HEAVY • 3×8–10";
  ...
  tempoLabel.id = "tempo-label-6";
  tempoLabel.textContent = "Tempo ▸";

  const tempoValue = document.createElement("span");
  tempoValue.id = "tempo-value-6";
  tempoValue.className = "hidden";
  tempoValue.textContent = "3-1-2";
  ...
  timerDisplay.id = "timer-display-6";
